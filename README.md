...
This version is based on AOSP 14
...
Select the release of AOSP 14 you want, e.g. r21:
```
...
```
$ repo init --depth=1 -u https://android.googlesource.com/platform/manifest -b android-14.0.0_r21
```

Get Marvin and sync
```
$ cd ~/aosp
$ git clone https://github.com/xrda3team/local-manifest .repo/local_manifests -b android14
$ repo sync -c
```
